import unittest
from mantid.simpleapi import Load, CloneWorkspace, DeleteWorkspace, TOFTOFCleanSampleLogs, AddSampleLogMultiple, \
    DeleteLog
from testhelpers import run_algorithm
from mantid.api import AnalysisDataService


class TOFTOFCleanSampleLogsTest(unittest.TestCase):
    ...
    def test_success(self):
        ...
        alg_test = run_algorithm("TOFTOFCleanSampleLogs",
        ...
        self.assertEqual(run_out.getLogData('proposal_number').value, int(run_in.getLogData('proposal_number').value))
        ...
        self.assertEqual(run_out.getLogData('run_number').value, str([run_in.getLogData('run_number').value,
        ...
        self.assertEqual(run_out.getLogData('duration').value, float(run_in.getLogData('duration').value))
    ...
    def test_failed(self):
        ...
        self.assertRaises(RuntimeError,
                          run_algorithm, 'TOFTOFCleanSampleLogs',
