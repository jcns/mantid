...
class DNSSetupWidget(BaseWidget):
    ...
    def __init__(self, settings):
        ...
        def _frame(grid, lastcolumn, lastrow):
        ...
        grid = QGridLayout()
        grid.addWidget(frameSampleData,        0, 0, 7, 7)
        ...
        grid.addWidget(self.runsView,          3, 1, 1, 5)
        _frame(grid, 7, 7)
        ...
        grid.addWidget(frameMaskDetector,  0, 0, 7, 7)
        _frame(grid, 7, 7)
        ...
        #grid = QGridLayout()
        #grid.addWidget(QLabel('Output directory'),   1, 2)
        #grid.addWidget(frameSave)
        grid = QGridLayout()
        grid.addWidget(frameSave,                           0, 0, 7, 7)
        ...
        grid = QGridLayout()
        grid.addWidget(frameStandardData,           0, 0, 7, 7)
        ...
        grid = QGridLayout()
        grid.addWidget(frameDataRed,                                 0, 0, 9, 6)
        ...
        grid = QGridLayout()
        grid.addWidget(frameOutput,                  0, 0, 14, 13)
        grid.addWidget(self.rbnPolyAmor,             1, 1, 1, 5)
        grid.addWidget(QLabel('Abscissa'),           2, 2, 1, 3)
        grid.addWidget(self.chkAxQ,                  3, 2, 1, 3)
        grid.addWidget(self.chkAxD,                  3, 4, 1, 2)
        grid.addWidget(self.chkAx2Theta,             3, 6, 1, 2)
        ...
        grid.addWidget(self.rbnSingleCryst,          6, 1, 1, 4)
        grid.addWidget(QLabel('Omega offset'),       7, 2, 1, 2)
        grid.addWidget(self.omegaOffset,             7, 4, 1, 2)
        grid.addWidget(QLabel("Lattice parameters"), 8, 2, 1, 3)
        grid.addWidget(QLabel('a[\305]'),            9, 2, 1, 2)
        grid.addWidget(self.latticeA,                9, 3, 1, 2)
        grid.addWidget(QLabel('b[\305]'),            9, 5)
        grid.addWidget(self.latticeB,                9, 6, 1, 2)
        grid.addWidget(QLabel('c[\305]'),            9, 8)
        grid.addWidget(self.latticeC,                9, 9, 1, 2)
        grid.addWidget(QLabel(u'\u03B1[\u00B0]'),   10, 2, 1, 2)
        grid.addWidget(self.latticeAlpha,           10, 3, 1, 2)
        grid.addWidget(QLabel(u'\u03B2[\u00B0]'),   10, 5)
        grid.addWidget(self.latticeBeta,            10, 6, 1, 2)
        grid.addWidget(QLabel(u'\u03B3[\u00B0]'),   10, 8)
        grid.addWidget(self.latticeGamma,           10, 9, 1, 2)
        grid.addWidget(QLabel('Scattering Plane'),  11, 2, 1, 3)
        grid.addWidget(QLabel('u'),                 12, 2)
        grid.addWidget(self.scatterU1,              12, 3)
        grid.addWidget(self.scatterU2,              12, 4, 1, 2)
        grid.addWidget(self.scatterU3,              12, 6)
        grid.addWidget(QLabel('v'),                 12, 7)
        grid.addWidget(self.scatterV1,              12, 8, 1, 2)
        grid.addWidget(self.scatterV2,              12, 10)
        grid.addWidget(self.scatterV3,              12, 11)
        #grid.setColumnMinimumWidth(1, 30)

        for i in range(1, 12):
            grid.setRowMinimumHeight(i, 35)
